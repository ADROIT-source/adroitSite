...
function AppContent() {
  ...
  useEffect(() => {
    ...
    if (location.pathname === "/saladybot") {
      document.title = "샐러디봇: AI 기반 초개인화 샐러드 자동화 | ㈜애드로이트(Adroit)";
      setMeta(
        "description",
        "샐러디봇은 LLM과 비전 기반 지능형 로봇으로 개인의 건강 데이터와 취향을 분석해 맞춤형 샐러드를 제조하는 혁신적인 자동화 솔루션입니다."
      );
      setMeta("keywords", "샐러디봇, AI 로봇, 초개인화 샐러드, 6축 양팔 로봇, AI 비전, 스마트 팩토리, 애드로이트, Adroit");
      ...
      setMeta("og:title", "샐러디봇: AI 기반 초개인화 샐러드 자동화 | ㈜애드로이트(Adroit)", true);
      ...
      setMeta("twitter:title", "샐러디봇: AI 기반 초개인화 샐러드 자동화 | ㈜애드로이트(Adroit)");
      ...
      script.text = JSON.stringify(
        {
          ...
          "@type": "Product",
          name: "샐러디봇",
          alternateName: "SaladyBot",
          url: "https://www.adroit.co.kr/saladybot",
          image:
            "https://cdn.prod.website-files.com/6874b1bc483ad88f0211b655/6874b72f00f201a6eb9e64cc_adroit_saladybot.png",
          description:
            "샐러디봇은 LLM과 비전 기술로 개인 맞춤 샐러드를 제조하는 지능형 로봇 시스템입니다. 6축 양팔 로봇과 데이터 기반 최적화로 스마트 팩토리를 구현.",
          brand: {
            "@type": "Brand",
            name: "㈜애드로이트",
          ...
          sameAs: ["https://www.linkedin.com/company/adroit", "https://twitter.com/AdroitCorp"],
        },
        null,
        2
      );
      ...
      document.title = "㈜애드로이트(Adroit) | 혁신적인 로봇 시스템 통합 솔루션";
      setMeta(
        "description",
        "㈜애드로이트(Adroit)는 지능형 로봇·AI 자동화, AI 비전 검사/딥러닝 분류, 2D/3D 시뮬레이션(OLP), AMR 및 Recyclon 재활용 분류 로봇까지 맞춤형 시스템 통합으로 생산성·품질·ESG를 향상합니다."
      );
      setMeta("keywords", "애드로이트, Adroit, 지능형 로봇, AI 자동화, AI 비전, 딥러닝, 2D/3D 시뮬레이션, AMR, Recyclon, 스마트 팩토리");
      setMeta("robots", "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1");
      ...
      setMeta("og:title", "㈜애드로이트(Adroit) | 혁신적인 로봇 시스템 통합 솔루션", true);
      setMeta(
        "og:description",
        "㈜애드로이트(Adroit)는 지능형 로봇과 AI 자동화로 스마트한 생산 환경을 구현합니다. AI 비전·딥러닝 분류, 2D/3D 시뮬레이션(OLP), AMR, Recyclon 등 맞춤형 통합 솔루션.",
        true
      );
      setMeta(
        "og:image",
        "https://cdn.prod.website-files.com/6874b1bc483ad88f0211b655/6874b72f00f201a6eb9e64cc_adroit_dark_classy_2.png",
        true
      );
      ...
      // Twitter
      setMeta("twitter:card", "summary_large_image");
      setMeta("twitter:title", "㈜애드로이트(Adroit) | 혁신적인 로봇 시스템 통합 솔루션");
      setMeta("twitter:description", "Adroit - AI 비전·딥러닝 분류, 2D/3D 시뮬레이션(OLP), AMR, Recyclon 등 맞춤형 로봇·AI 통합 솔루션.");
      setMeta(
        "twitter:image",
        "https://cdn.prod.website-files.com/6874b1bc483ad88f0211b655/6874b72f00f201a6eb9e64cc_adroit_dark_classy_2.png"
      );
      ...
      script.text = JSON.stringify(
        {
          ...
          logo:
            "https://cdn.prod.website-files.com/6874b1bc483ad88f0211b655/6874b72f00f201a6eb9e64cc_adroit_dark_classy_2.png",
          description:
            "㈜애드로이트(Adroit)는 지능형 로봇과 AI 자동화 솔루션을 설계·개발·구축하는 로봇 시스템 통합 기업. AI 비전 검사, 딥러닝 분류, 2D/3D 시뮬레이션(OLP), AMR, 재활용 분류 로봇(Recyclon) 제공.",
          contactPoint: [
            {
              "@type": "ContactPoint",
              contactType: "sales",
