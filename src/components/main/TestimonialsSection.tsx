  ...
  return (
    <div id="testimonials" className="TestimonialsSection">
      <FadeInSection direction="up" duration={800} className="flex-direction-center">
        ...
        <h1>고객이 전하는</h1>
        <h1>생생한 경험담</h1>
        <p>실제 도입 기업들의 솔직한 후기를 통해 우리 로봇 기술의 진가를 확인해 보세요</p>
      </FadeInSection>
      <FadeInSection direction="up" duration={800} className="TestimonialsSection_card">
        <li>
          <div className="scope">
          ...
          <p>로봇팔 도입 후 생산 효율이 3배 증가했습니다. 특히 정밀도와 안정성이 뛰어나 24시간 무정지 생산이 가능해졌어요.</p>
