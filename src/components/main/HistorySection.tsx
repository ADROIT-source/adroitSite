...
const historyData: YearGroup[] = [
  ...
  },
  {
    year: "2025",
    projects: [
      { title: "프로젝트", desc: "철도궤도프레임(철도청) 쇼트 로봇 자동화 PJT" },
      { title: "프로젝트", desc: "농심(주) 인케이싱 라인 로봇 자동화 PJT" },
      {
        title: "프로젝트",
        desc: "기아자동차(광주) 플러그 라인 로봇 프로그램 PJ",
      },
      { title: "프로젝트", desc: "현대자동차(전주) 비전 시스템 PJT" },
      { title: "프로젝트", desc: "롯데홈쇼핑 디팔렛타이징 로봇 자동화 PJT" },
      {
        title: "프로젝트",
        desc: "기아자동차(광주) 붓터치 라인 로봇 프로그램 PJT",
      },
    ],
  },
];
